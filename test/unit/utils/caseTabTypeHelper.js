...
const nonProdTabIds = [
  ...
  'serviceApplicationForPetSol',
  'serviceApplicationForCitizen',
  'serviceApplicationForCourtAdmin',
  'serviceApplicationCourtAdminBeta',
  'serviceApplicationForSysUpdate',
  'serviceApplicationForBulkScan',
  'serviceApplicationForLa',
  'serviceApplicationForSuperUser',
  'serviceApplicationForPcq',
  'LinkedCase',
  'generalReferral',
  'Language',
